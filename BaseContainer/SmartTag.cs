...
// ***********************************************************************
// <copyright file="SmartTag.cs" company="">
...
namespace Zeroit.Framework.BarProgressThematic.Controls
{
    ...
    /// <summary>
    /// Class BarProgressDesigner.
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Design.ControlDesigner" />
    [System.Security.Permissions.PermissionSet(System.Security.Permissions.SecurityAction.Demand, Name = "FullTrust")]
    public class BarProgressDesigner : System.Windows.Forms.Design.ControlDesigner
    {
        /// <summary>
        /// The action lists
        /// </summary>
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new BarProgressSmartTagActionList(this.Component));
                }
                return actionLists;
            }
        }
    ...
    /// <summary>
    /// Class BarProgressSmartTagActionList.
    /// </summary>
    /// <seealso cref="System.ComponentModel.Design.DesignerActionList" />
    public class BarProgressSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        //Replace SmartTag with the Component Class Name. In this case the component class name is SmartTag
        /// <summary>
        /// The col user control
        /// </summary>
        private BarProgressThematic colUserControl;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BarProgressSmartTagActionList"/> class.
        /// </summary>
        /// <param name="component">A component related to the <see cref="T:System.ComponentModel.Design.DesignerActionList" />.</param>
        public BarProgressSmartTagActionList(IComponent component) : base(component)
        {
            this.colUserControl = component as BarProgressThematic;
        ...
        {
            get { return colUserControl.ProgressStyle; }
            set
            {
                GetPropertyByName("ProgressStyle").SetValue(colUserControl, value);
            }
        }
